...
---
<iframe src="https://www.canva.com/design/DAEEH3fm7_4/mOV7EF13bg7faf_JZ_lrKw/view#22" borderColor="0"><iframe>
...
class: center, middle
<img src="https://raw.githubusercontent.com/allisonhorst/stats-illustrations/master/rstats-artwork/patchwork_1.jpg" height="500px" alt="Fuzzy cartoon monsters in white gloves and uniforms hanging multiple plots together on a wall, with an artist monster wearing a beret and smock directing them to the correct orientation. There is a blueprint plan on the wall showing how the plots should be arranged. Stylized title font reads 'patchwork - combine & arrange your ggplots!'">
.pull-right[
###### [@allisonhorst](https://twitter.com/allisonhorst)
]
---
...
- [{Patchwork}](https://patchwork.data-imaginist.com/) - Assembling separate plots into one overall figure.
---
## Patchwork
